...
**Status:** BRANDING-REFINED DRAFT COMPLETE — Gate 5 pending user approval  
...
## 2A. Personal-branding system — carried forward from the Weir Research article

The earlier `weir-web-article` establishes a useful authorship pattern: the research remains the hero, while the author identity is visible in page metadata, hero metadata and a closing author card. GWRPZ should use the same principle to create a recognisable research series without turning the article into a portfolio page.

### Brand hierarchy

**Primary:** article title and evidence story.  
**Secondary:** `KG` research signature.  
**Tertiary:** author profile / collaboration route.

### Persistent site identity

Use a small circular `KG` mark in the header, followed by the article title:

> `KG`  **From Mapping to Decision**

Do not use `GIS Expert`, `Hydrogeologist`, `NRM Expert` or similar promotional labels in the persistent header. The article should demonstrate those capabilities through its reasoning and evidence.
...
- OpenGraph site name: `Kaushal Gadariya — Research Articles`
- description: practitioner-focused interactive evidence story on groundwater recharge planning using GIS, MCDA, field knowledge, hydrogeological reasoning and community-informed decisions in Sabarkantha, Gujarat.
- canonical: final GitHub Pages article URL.

### Hero authorship

Below the opening dek, use one compact metadata row:

> **Kaushal Gadariya** · Soil and Water Conservation Engineer · Groundwater · GIS · Watershed & NRM

This should be visually secondary to the article title and practitioner quote.

### Visual identity

Carry forward the research-publication family from the Weir article:

- deep navy — research / authority;
- warm off-white / paper — reading surface;
- teal — primary technical accent;
- aqua — interactive / focus accent;
- restrained coral — caution / selected emphasis.

This establishes continuity across research articles while GWRPZ retains its own map-driven layouts and recharge-specific legends.

### Author card

Near the end, after the evidence and collapsed references, use a dark author card with:

- Kaushal Gadariya;
- Soil and Water Conservation Engineer;
- concise provenance: postgraduate research on recharge-site identification using MCDA + Remote Sensing + GIS; applied field/professional work on the theme since 2019;
- LinkedIn;
- Portfolio;
- restrained collaboration route.

### Series rule

Future technical articles may reuse the same `KG` mark, typography family, palette and author-card structure. The article topic changes; the research identity remains recognisable.
...
- nearest lineament:
  - min **27.4 m**
  - median **1,209.5 m**  - max **5,177.5 m**
...
This revision supersedes `Web_Article_Content_Architecture_v0.3.md`.
