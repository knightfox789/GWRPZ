...
## 2A. Research-series branding interaction
...
- `KG` is a compact circular mark;
- article title remains the visible identity;
- no professional superlative appears in the header;
- header may include a thin reading-progress indicator, following the earlier Weir article pattern.

### Hero
Hero order:
1. small eyebrow — `Practitioner evidence story · Sabarkantha, Gujarat`;
2. H1 — `From Mapping to Decision`;
3. practitioner quote — `GIS helps validate the evidence. The decision still has to be made in the field, with the community.`;
4. short explanatory dek;
5. compact author metadata — `Kaushal Gadariya · Soil and Water Conservation Engineer · Groundwater · GIS · Watershed & NRM`;
6. `Follow the evidence` CTA into the story.

The quote is a belief / practitioner principle, not a claim derived from the GIS analysis.

### Author card
At the end of the story:
- dark navy card;
- author name and professional title;
- 2–3 sentence provenance;
- LinkedIn;
- Portfolio;
- one collaboration prompt.
...
CTA appears after substantive evidence, never as a hero-level sales button.

### SEO/share requirements for Phase 6
- author meta;
- canonical URL;
- OpenGraph title/description/site-name;
- Twitter/X summary metadata;
- semantic `article` structure where practical;
- JSON-LD `Article` / `Person` may be added if implemented accurately.
...
This v0.4 supersedes `Interaction_Specification_v0.3.md`.
